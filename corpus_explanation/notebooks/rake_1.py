...
# %% [code]
explanations = RakePerClassExplanations("rake-per-class-300-1", dataset, experiment.config)
...
model = MLPGen("mlp-gen_rake_class_cleaned_1", MODEL_MAPPING, experiment.config, dataset, explanations)
