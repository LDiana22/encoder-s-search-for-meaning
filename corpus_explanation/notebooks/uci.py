...
class IMDBDataset:
  ...
  def __init__(self, args, max_length=250):
    ...
    # self.train_data = self._load_data(TEXT, LABEL, "drive/My Drive/encoder/.data/aclimdb", "train")
    # self.test_data = self._load_data(TEXT, LABEL, "drive/My Drive/encoder/.data/aclimdb", "test")
...
class UCIDataset:
  ...
  def __init__(self, args, max_length=250):
    ...
    # self.train_data, self.test_data, self.valid_data = self._load_data(TEXT, LABEL, "drive/My Drive/encoder/uci") # 0.6,0.2,0.2
    self.train_data, self.test_data, self.valid_data = self._load_data(TEXT, LABEL, "../.data/uci") # 0.6,0.2,0.2
    print("UCI...")
    print(f"Train {len(self.train_data)}")
    print(f"Valid {len(self.valid_data)}")
    print(f"Test {len(self.test_data)}")
