...
# %% [code]
explanations = RakePerClassExplanations("rake-per-class-300-4", dataset, experiment.config)
...
model = MLPGen("mlp-gen_rake_class_cleaned_4", MODEL_MAPPING, experiment.config, dataset, explanations)
