...
#     self.train_data, self.test_data =  datasets.IMDB.splits(TEXT, LABEL)
    ...
    print(self.train_data[0].text + " ~ "+ self.train_data[0].label)
    print("First val text: ")
    print(self.valid_data[0].text + " ~ "+ self.valid_data[0].label)
    print("First test text: ")
    print(self.test_data[0].text + " ~ "+ self.test_data[0].label)
    print("IMDB...")
