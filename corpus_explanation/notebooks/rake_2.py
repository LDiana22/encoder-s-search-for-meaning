...
# %% [code]
explanations = RakePerClassExplanations("rake-per-class-300-2", dataset, experiment.config)
...
model = MLPGen("mlp-gen_rake_class_cleaned_2", MODEL_MAPPING, experiment.config, dataset, explanations)
