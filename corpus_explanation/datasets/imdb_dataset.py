...
class IMDBDataset:
  ...
  def __init__(self, args, max_length=250):
    ...
    self.train_data = self._load_data(TEXT, LABEL, "cc_scripts/.data/imdb/aclImdb", "train")
    print(len(self.train_data.examples))
    self.test_data = self._load_data(TEXT, LABEL, "cc_scripts/.data/imdb/aclImdb", "test")
    print(len(self.train_data.examples))
